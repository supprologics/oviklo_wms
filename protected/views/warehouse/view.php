            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Location - FORM</h4>
                    </div>
                    <div class="modal-body">

                        <div class="cus-form">
                            <form class="form-horizontal" action="<?php echo Yii::app()->createUrl('Locations/create') ?>" method="post" id="Locations-form">
                                <input type="hidden" name="warehouse_id" value="<?php echo $model->id; ?>" />
                                ...
                                <div class="form-group row">
                                    <label for="max_cbm" class="col-sm-4 control-label">Max CBM</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" id="max_cbm" name="max_cbm" placeholder="MAX CBM">
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div>
            <div class="table-box">
                ...
                <div class="row no-gutters">
                    ...
                    <div class='col headerdiv'>MAX CBM</div>
