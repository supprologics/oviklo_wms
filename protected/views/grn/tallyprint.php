<?php
$mPDF1 = new mpdf('', 'A4', 0, 'Arial', 20, 5, 98, 20, 4, 4, 'P');
...
<div>
    ...
    <h3 style="text-align: center;">Tally Update </h3>
...
<div>
    <table cellspacing="0" cellpadding="0" width="100%" class="borderd" style="overflow: wrap;">
        ...
        foreach ($list as $value) {
            ...
            <tr>
                ...
                <td><?php echo isset($poitems->locations_id) ? $poitems->locations->name : ""; ?></td>
    ...
    <div style="margin-top: 50px; font-size: 10px; margin-bottom: 55px;">
        <table cellspacing="0" cellpadding="0" width="100%" class="borderd morepad" >
            <tr>
                <td width="25%">Name</td>
                <td></td>
            </tr>
