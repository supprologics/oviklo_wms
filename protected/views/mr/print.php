<?php
$mPDF1 = new mpdf('', 'A4', 0, 'Arial', 20, 5, 110, 20, 4, 4, 'P');
...
<div>
    ...
    <h3 style="text-align: center;">Material Request Note </h3>
...
<div>
    <table cellspacing="0" cellpadding="0" width="100%" class="borderdAll" style="overflow: wrap;">
        ...
        <?php
        $po_id = $model->id;
        $list = Yii::app()->db->createCommand("SELECT id FROM mr_items WHERE mr_id = '$po_id'")->queryAll();
        $num = 1;
        $tot = 0;
        $totamount = 0;

        foreach ($list as $value) {
            $poitems = MrItems::model()->findByPk($value['id']);
            ?>
            <tr>
                <td><?php echo $num; ?></td>
                ...
                <td><?php echo $poitems->remarks; ?></td>
    ...
    <div style="margin-top: 50px; font-size: 10px; margin-bottom: 55px;">
        <table cellspacing="0" cellpadding="0" width="100%" >
            <tr>
                ...
                <td><br/>............................................<br/>Authorized by By</td>
                <td><br/>............................................<br/>Accepted by</td>
            </tr>
        </table>
    </div>
