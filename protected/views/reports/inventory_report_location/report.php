    ...
    <body>
        ...
        <div class="report_body" >
            ...
            <div class="row">
                ...
                <div class="col text-right">
                    <h2 class="report_header">Inventory Report By Location</h2>
                </div>
                ...
                <table id="popularity" class="table data reports_table table-sm table-bordered" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tbody>
                        ...
                        $stocklot = Yii::app()->db->createCommand("SELECT "
                                        . "SUM(qty) as tot,"
                                        . "warehouse_id,"
                                        . "batch_no,locations_id,sub_location,"
                                        . "sku_id,"
                                        . "goods_sts_id "
                                        . "FROM stock WHERE "
                                        . "customers_id = '" . $customer->id . "' AND tbl_name IN ('grn','pick','tn') $warehouse_id $project_id $goodsSts_id $sku_q $effdate "
                                        . "GROUP BY "
                                        . "goods_sts_id,sku_id,warehouse_id,locations_id,sub_location HAVING tot != 0 ORDER BY sku_id ASC")->queryAll();
