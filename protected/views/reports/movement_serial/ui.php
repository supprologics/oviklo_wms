...
<div class="row">
    <div class="col">
        ...
        <form target="_blank" class="form-horizontal" action="<?php echo Yii::app()->createUrl('reports/loadreport/') ?>" method="post" >
            ...
            <div class="form-row mb-2">
                <label for="batch" class="col-sm-2 control-label">SERIAL</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control form-control-sm" id="serial" name="serial" placeholder="Serial No">
                </div>
            </div>
            ...
            <div class="form-row mb-2">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control form-control-sm datepicker" id="date_from" name="date_from" value="<?php echo date("Y-m-01"); ?>" placeholder="Start Date">
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control form-control-sm datepicker" id="date_to" name="date_to" value="<?php echo date("Y-m-d"); ?>" placeholder="Start Date">
                </div>
            </div>
