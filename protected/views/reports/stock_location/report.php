            ...
            <div id='popularity_s'>
                ...
                <table id="popularity" class="table data reports_table table-sm table-bordered" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    $stocklot = Yii::app()->db->createCommand("SELECT "
                                    ...
                                    . "batch_no,"
                                    . "sku_id,"
                                    . "p_id,sub_location,locations_id,"
                                    . "project_id,"
                                    ...
                                    . "GROUP BY "
                                    . "batch_no,goods_sts_id,sku_id,project_id,warehouse_id,locations_id,sub_location HAVING tot != 0 ORDER BY expire_date ASC")->queryAll();
