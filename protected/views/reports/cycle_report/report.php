    ...
    <body>
        ...
        <div class="report_body" >
            ...
            <div class="row">
                ...
                <div class="col text-right">
                    <h2 class="report_header">Cycle Count Report</h2>
                </div>
                ...
                <table id="popularity" class="table data reports_table table-sm table-bordered" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tbody>
                        ...
                        $stocklot = Yii::app()->db->createCommand("SELECT "
                                        ...
                                        . "GROUP BY "
                                        . "goods_sts_id,sku_id,warehouse_id HAVING tot != 0 ORDER BY sku_id ASC")->queryAll();
                ...
                <div class="container-fluid">
                    <div class="row">
                        <table class="table table-sm">
                            ...
                            <tr class="table-active">
                                <td style="padding: 15px; border-bottom: 1px dashed #616161;"></td>
                                <td style="padding: 15px; border-bottom: 1px dashed #616161;"></td>
                                <td style="padding: 15px; border-bottom: 1px dashed #616161;"></td>
                            </tr>
                        </table>
