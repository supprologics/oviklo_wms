...
class ProjectController extends Controller {
    ...
    public function actionjsondata($id) {
        $data = Project::model()->findByPk($id);
    ...
    public function actionloadlist($id) {
        ...
        $list = Project::model()->findAllByAttributes(array("customers_id" => $id));
    ...
    public function actionIndex() {
        ...
        $sql = "SELECT * FROM project WHERE online = 1 $searchtxt ORDER BY id DESC ";
