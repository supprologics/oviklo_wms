...
class GoodsStsController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = GoodsSts::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM goods_sts WHERE online = 1 $searchtxt ORDER BY id DESC ";                
	...
	{
		$model=GoodsSts::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='goods-sts-form')
		{
