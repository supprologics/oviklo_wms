...
class Pick extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('mr_id', 'required'),
			array('mr_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, mr_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'gdns' => array(self::HAS_MANY, 'Gdn', 'pick_id'),
			'mr' => array(self::BELONGS_TO, 'Mr', 'mr_id'),
			'pickItems' => array(self::HAS_MANY, 'PickItems', 'pick_id'),
		);
	}
